...
import HplAssets.ComponentModel.Parsers.PrintComponentModel
...
main = do args <- getArgs
          case args of
            [] -> hGetContents stdin >>= run 2 pComponentModel
            "-s":fs -> mapM_ (runFile 0 pComponentModel) fs
            fs -> mapM_ (runFile 2 pComponentModel) fs
