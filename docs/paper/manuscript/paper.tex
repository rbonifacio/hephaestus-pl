...
%
  ...
  regard to the type of reusable assets and associated variability
  mechanisms that they target.
%
% Solution
%
  This problem is addressed in the present paper by capturing the
  commonality and managing variability of tools for product
  derivation. More specifically, the paper describes domain analysis,
  design, and implementation of \hpl---a proper product line for tools
  for product derivation. To this end, an extractive strategy was
  applied to the existing Haskell-based \hp{} tool. A general,
  transformational approach to variability management is designed and
  implemented by metaprogramming in Haskell. We also describe a
  reactive process for evolving \hpl{} to address new types of
  artifacts.
%
% Evidence
%
